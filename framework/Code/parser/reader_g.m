...
/* The size of an array large to enough to hold all stacks, each with
   N elements.  */
#define YYSTACK_BYTES(N) #warning 64BIT: Inspect use of sizeof
#warning 64BIT: Inspect use of sizeof
#warning 64BIT: Inspect use of sizeof
#warning 64BIT: Inspect use of sizeof
...
#ifndef YYCOPY
#if 1 < __GNUC__
#define YYCOPY(To, From, Count) #warning 64BIT: Inspect use of sizeof
#warning 64BIT: Inspect use of sizeof
...
#define YYDSYMPRINTF(Title, Token, Value, Location)     \
	do {                                                \
		if (yydebug) {                                  \
			...
			yysymprint(stderr, Token, Value, Location); \
			YYFPRINTF(stderr, "\n");                    \
		}                                               \
	} while (0)
...
NSInteger yyparse(void* YYPARSE_PARAM)
#else
NSInteger yyparse(YYPARSE_PARAM) void* YYPARSE_PARAM;
#endif
#else /* ! YYPARSE_PARAM */
#if defined(__STDC__) || defined(__cplusplus)
NSInteger
